...
DRAGGABLE_BLOCKS = [
    ...
    {"name": "DataLoader", "lib": "PyTorch", "color": "block_data",
     "template": "DataLoader({dataset}, batch_size={bs}, shuffle={shuffle})"},
    {"name": "Dataset", "lib": "PyTorch", "color": "block_data",
     "template": "class {name}(Dataset):\n    def __getitem__(self, idx):\n        return ..."},
    {"name": "TensorDataset", "lib": "PyTorch", "color": "block_data",
     "template": "TensorDataset({data_tensor}, {label_tensor})"},
    {"name": "train_test_split", "lib": "Scikit-learn", "color": "block_data",
     "template": "train_test_split({X}, {y}, test_size={size}, random_state={seed})"},
    ...
    {"name": "nn.ConvTranspose2d", "lib": "PyTorch", "color": "block_model",
     "template": "nn.ConvTranspose2d({in_c}, {out_c}, kernel_size={k}, stride={s}, padding={p})"},
    ...
    {"name": "nn.LayerNorm", "lib": "PyTorch", "color": "block_model",
     "template": "nn.LayerNorm({dim})"},
    ...
    {"name": "nn.AvgPool2d", "lib": "PyTorch", "color": "block_model",
     "template": "nn.AvgPool2d({k}, stride={s})"},
    {"name": "nn.AdaptiveAvgPool2d", "lib": "PyTorch", "color": "block_model",
     "template": "nn.AdaptiveAvgPool2d({output_size})"},
    {"name": "nn.LSTM", "lib": "PyTorch", "color": "block_model",
     "template": "nn.LSTM({input_size}, {hidden_size}, num_layers={n}, batch_first=True)"},
    {"name": "nn.GRU", "lib": "PyTorch", "color": "block_model",
     "template": "nn.GRU({input_size}, {hidden_size}, num_layers={n}, batch_first=True)"},
    {"name": "nn.Embedding", "lib": "PyTorch", "color": "block_model",
     "template": "nn.Embedding({vocab_size}, {embed_dim})"},

    # ===== 激活函数 =====
    {"name": "F.relu", "lib": "PyTorch", "color": "block_model",
     "template": "F.relu({x})"},
    {"name": "F.leaky_relu", "lib": "PyTorch", "color": "block_model",
     "template": "F.leaky_relu({x}, negative_slope={slope})"},
    {"name": "F.gelu", "lib": "PyTorch", "color": "block_model",
     "template": "F.gelu({x})"},
    {"name": "F.sigmoid", "lib": "PyTorch", "color": "block_model",
     "template": "torch.sigmoid({x})"},
    {"name": "F.tanh", "lib": "PyTorch", "color": "block_model",
     "template": "torch.tanh({x})"},
    {"name": "F.softmax", "lib": "PyTorch", "color": "block_model",
     "template": "F.softmax({x}, dim={dim})"},
    {"name": "F.log_softmax", "lib": "PyTorch", "color": "block_model",
     "template": "F.log_softmax({x}, dim={dim})"},
    ...
    {"name": "nn.MSELoss", "lib": "PyTorch", "color": "block_loss",
     "template": "nn.MSELoss()"},
    {"name": "nn.BCEWithLogitsLoss", "lib": "PyTorch", "color": "block_loss",
     "template": "nn.BCEWithLogitsLoss()"},
    {"name": "nn.L1Loss", "lib": "PyTorch", "color": "block_loss",
     "template": "nn.L1Loss()"},
    {"name": "nn.SmoothL1Loss", "lib": "PyTorch", "color": "block_loss",
     "template": "nn.SmoothL1Loss()"},
    ...
    {"name": "optim.RMSprop", "lib": "PyTorch", "color": "block_optim",
     "template": "optim.RMSprop({params}, lr={lr})"},
    {"name": "optim.lr_scheduler.StepLR", "lib": "PyTorch", "color": "block_optim",
     "template": "lr_scheduler.StepLR({optimizer}, step_size={step}, gamma={gamma})"},
    {"name": "optim.lr_scheduler.CosineAnnealingLR", "lib": "PyTorch", "color": "block_optim",
     "template": "lr_scheduler.CosineAnnealingLR({optimizer}, T_max={T}, eta_min={min_lr})"},

    # ===== 张量操作 =====
    {"name": "torch.flatten", "lib": "PyTorch", "color": "block_transform",
     "template": "torch.flatten({x}, start_dim={dim})"},
    {"name": "torch.reshape", "lib": "PyTorch", "color": "block_transform",
     "template": "torch.reshape({x}, ({shape}))"},
    {"name": "torch.cat", "lib": "PyTorch", "color": "block_transform",
     "template": "torch.cat([{tensors}], dim={dim})"},
    {"name": "torch.stack", "lib": "PyTorch", "color": "block_transform",
     "template": "torch.stack([{tensors}], dim={dim})"},
    {"name": "torch.argmax", "lib": "PyTorch", "color": "block_transform",
     "template": "torch.argmax({x}, dim={dim})"},
    {"name": "torch.where", "lib": "PyTorch", "color": "block_transform",
     "template": "torch.where({condition}, {x}, {y})"},
    {"name": "torch.clamp", "lib": "PyTorch", "color": "block_transform",
     "template": "torch.clamp({x}, min={min_val}, max={max_val})"},
    ...
    {"name": "transforms.Normalize", "lib": "PyTorch", "color": "block_transform",
     "template": "transforms.Normalize({mean}, {std})"},
    {"name": "transforms.Compose", "lib": "PyTorch", "color": "block_transform",
     "template": "transforms.Compose([{transforms_list}])"},
    {"name": "transforms.RandomHorizontalFlip", "lib": "PyTorch", "color": "block_transform",
     "template": "transforms.RandomHorizontalFlip(p={p})"},
    {"name": "transforms.RandomCrop", "lib": "PyTorch", "color": "block_transform",
     "template": "transforms.RandomCrop({size})"},
    {"name": "transforms.ColorJitter", "lib": "PyTorch", "color": "block_transform",
     "template": "transforms.ColorJitter(brightness={b}, contrast={c})"},
    {"name": "cv2.cvtColor", "lib": "OpenCV", "color": "block_transform",
     "template": "cv2.cvtColor({img}, cv2.COLOR_{c1}2{c2})"},
    {"name": "cv2.resize", "lib": "OpenCV", "color": "block_transform",
     "template": "cv2.resize({img}, ({w}, {h}))"},
    {"name": "cv2.GaussianBlur", "lib": "OpenCV", "color": "block_transform",
     "template": "cv2.GaussianBlur({img}, ({k}, {k}), {sigma})"},

    # ===== 训练 / 模型管理 =====
    {"name": "torch.save", "lib": "PyTorch", "color": "block_optim",
     "template": "torch.save({model}.state_dict(), \"{path}.pth\")"},
    {"name": "torch.load", "lib": "PyTorch", "color": "block_optim",
     "template": "{model}.load_state_dict(torch.load(\"{path}.pth\"))"},
    {"name": "model.train()", "lib": "PyTorch", "color": "block_optim",
     "template": "model.train()"},
    {"name": "model.eval()", "lib": "PyTorch", "color": "block_optim",
     "template": "model.eval()"},
    {"name": "torch.no_grad", "lib": "PyTorch", "color": "block_metric",
     "template": "with torch.no_grad():\n    {code}"},
    {"name": "optimizer.zero_grad", "lib": "PyTorch", "color": "block_optim",
     "template": "optimizer.zero_grad()"},
    {"name": "loss.backward", "lib": "PyTorch", "color": "block_optim",
     "template": "loss.backward()"},
    {"name": "optimizer.step", "lib": "PyTorch", "color": "block_optim",
    ...
    {"name": "confusion_matrix", "lib": "Scikit-learn", "color": "block_metric",
     "template": "confusion_matrix({y_true}, {y_pred})"},
    {"name": "classification_report", "lib": "Scikit-learn", "color": "block_metric",
     "template": "print(classification_report({y_true}, {y_pred}))"},

    # ===== 模型架构 / 预训练 =====
    {"name": "resnet18()", "lib": "PyTorch", "color": "block_model",
     "template": "resnet18(weights='IMAGENET1K_V1')"},
    {"name": "resnet50()", "lib": "PyTorch", "color": "block_model",
     "template": "resnet50(weights='IMAGENET1K_V1')"},
    {"name": "vgg16()", "lib": "PyTorch", "color": "block_model",
     "template": "vgg16(weights='IMAGENET1K_V1')"},

    # ===== 数组 / 工具 =====
    {"name": "np.array", "lib": "NumPy", "color": "block_data",
     "template": "np.array({data})"},
    {"name": "np.random.randn", "lib": "NumPy", "color": "block_data",
     "template": "np.random.randn({dims})"},
    {"name": "np.arange", "lib": "NumPy", "color": "block_data",
     "template": "np.arange({start}, {stop}, {step})"},
    {"name": "plt.plot", "lib": "Matplotlib", "color": "block_metric",
     "template": "plt.plot({x}, {y}, label='{label}')"},
    {"name": "plt.imshow", "lib": "Matplotlib", "color": "block_metric",
     "template": "plt.imshow({img}, cmap='{cmap}')\nplt.colorbar()"},
    {"name": "plt.show", "lib": "Matplotlib", "color": "block_metric",
     "template": "plt.show()"},
]
